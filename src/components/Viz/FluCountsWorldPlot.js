...
import initialSpec from '../../vega_specs/flu_world.vg.json';
...
const SequencingMapPlot = ({ width }) => {
  ...
  const { dataStore, globalSequencingDataStore } = useStores();

  const initialData = {
    //scores: globalSequencingDataStore.countryScoreData,
  };
