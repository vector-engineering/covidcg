...
const reds =  ["#FFF5F0", "#FEF1EB", "#FEEEE6", "#FEEAE1", "#FEE7DC", "#FEE3D7", "#FEE0D2", "#FDDACB", "#FDD4C3", "#FDCEBB", "#FCC8B3", "#FCC2AB", "#FCBCA3", "#FCB59B", "#FCAF93", "#FCA88B", "#FCA184", "#FC9B7C", "#FC9474", "#FB8D6D", "#FB8767"];
