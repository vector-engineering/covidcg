...
def clean_location_data(location_df):
    ...
    rules = [
        ...
        # Antwerp
        ({'country': 'Belgium', 'division': ['Antwerp', 'Antwerpen', 'Berchem', 'Berendrech-Zandvliet-Lillo', 'Borgerhout', 'Deurne', 'Ekeren', 'Hoboken', 'Merksem', 'Wilrijk']}, {'division': 'Antwerp', 'location': 'Antwerp'}),
        ({'country': 'Belgium', 'division': 'Balen'}, {'division': 'Antwerp', 'location': 'Balen'}),
        ({'country': 'Belgium', 'division': ['Beerse', 'Vlimmeren']}, {'division': 'Antwerp', 'location': 'Beerse'}),
        ({'country': 'Belgium', 'division': 'Bonheiden'}, {'division': 'Antwerp', 'location': 
        'Bonheiden'}),
        ({'country': 'Belgium', 'division': ['Bornem', 'Hingene', 'Wintam', 'Mariekerke', 'Weert']}, {'division': 'Antwerp', 'location': 'Bornem'}),
        ({'country': 'Belgium', 'division': 'Brasschaat'}, {'division': 'Antwerp', 'location': 
        'Brasschaat'}),
        ({'country': 'Belgium', 'division': ['Grobbendonk', 'Bouwel']}, {'division': 'Antwerp', 'location': 'Grobbendonk'}),
        ({'country': 'Belgium', 'division': ['Hemisem', 'Hemiksem']}, {'division': 'Antwerp', 'location': 'Hemiksem'}),
        ({'country': 'Belgium', 'division': ['Herselt', 'Ramsel']}, {'division': 'Antwerp', 'location': 'Herselt'}),
        ({'country': 'Belgium', 'division': ['Laakdal', 'Laakdaal', 'Veerle', 'Eindhout', 'Vorst', 'Varendonk', 'Vorst-Meerlaar', 'Klein-Vorst']}, {'division': 'Antwerp', 'location': 'Laakdal'}),
        ({'country': 'Belgium', 'division': ['Lille', 'Gierle']}, {'division': 'Antwerp', 'location': 'Lille'}),
        ...
        ({'country': 'Belgium', 'division': ['Malle', 'Oostmalle', 'Westmalle']}, {'division': 'Antwerp', 'location': 'Malle'}),
        ({'country': 'Belgium', 'division': ['Nijlen', 'Bevel', 'Kessel']}, {'division': 'Antwerp', 'location': 'Nijlen'}),
        ({'country': 'Belgium', 'division': 'Mol'}, {'division': 'Antwerp', 'location': 'Mol'}),
        ({'country': 'Belgium', 'division': ['Olen', 'Olen-Centrum', 'Saint-Martins', 'Boekel', 'Onze-Lieve-Vrouw-Olen', 'Achter-Olen', 'St.-Jozef-Olen', 'Olen-Fabriek']}, {'division': 'Antwerp', 'location': 'Olen'}),
        ({'country': 'Belgium', 'division': 'Oud-Turnhout'}, {'division': 'Antwerp', 'location': 'Oud-Turnhout'}),
        ({'country': 'Belgium', 'division': ['Puurs', 'Breendonk', 'Liezele', 'Kalfort', 'Ruisbroek']}, {'division': 'Antwerp', 'location': 'Puurs'}),
        ({'country': 'Belgium', 'division': ['Ravels', 'Poppel', 'Weelde']}, {'division': 'Antwerp', 'location': 'Ravels'}),
        ({'country': 'Belgium', 'division': ['Ranst', 'Broechem', 'Emblem', 'Oelegem']}, {'division': 'Antwerp', 'location': 'Ranst'}),
        ({'country': 'Belgium', 'division': ['Retie', 'Rethy', 'Schoonbroek']}, {'division': 'Antwerp', 'location': 'Retie'}),
        ({'country': 'Belgium', 'division': ['Rijkevorsel', 'Achtel', 'Sint-Jozef-Rijkevorsel', 'Gammel']}, {'division': 'Antwerp', 'location': 'Rijkevorsel'}),
        ({'country': 'Belgium', 'division': 'Schoten'}, {'division': 'Antwerp', 'location': 'Schoten'}),
        ({'country': 'Belgium', 'division': ['Sint-Amands', 'Lippelo', 'Oppuurs']}, {'division': 'Antwerp', 'location': 'Sint-Amands'}),
        ({'country': 'Belgium', 'division': 'Turnhout'}, {'division': 'Antwerp', 'location': 'Turnhout'}),
        ({'country': 'Belgium', 'division': 'Vorselaar'}, {'division': 'Antwerp', 'location': 'Vorselaar'}),
        ({'country': 'Belgium', 'division': 'Oevel'}, {'division': 'Antwerp', 'location': 'Westerlo'}),
        ({'country': 'Belgium', 'division': 'Wijnegem'}, {'division': 'Antwerp', 'location': 'Wijnegem'}),
        ({'country': 'Belgium', 'division': ['Willebroek', 'Blaasveld', 'Heindonk', 'Tisselt', 'Klein Willebroek']}, {'division': 'Antwerp', 'location': 'Willebroek'}),
        ({'country': 'Belgium', 'division': ['Zoersel', 'Halle', 'St. Antonius']}, {'division': 'Antwerp', 'location': 'Zoersel'}),

        # East Flanders
        ({'country': 'Belgium', 'division': ['Aalter', 'Lotenhulle']}, {'division': 'East Flanders', 'location': 'Aalter'}),
        ({'country': 'Belgium', 'division': ['Beveren', 'Doel', 'Haasdonk', 'Kallo', 'Kieldrecht', 'Melsele', 'Verrebroek', 'Vrasene', 'Beveren-Waas']}, {'division': 'East Flanders', 'location': 'Beveren'}),
        ({'country': 'Belgium', 'division': ['Buggenhout', 'Briel', 'Opdorp', 'Opstal']}, {'division': 'East Flanders', 'location': 'Buggenhout'}),
        ...
        ({'country': 'Belgium', 'division': ['Asper', 'Gavere']}, {'division': 'East Flanders', 'location': 'Gavere'}),
        ({'country': 'Belgium', 'division': ['Gent', 'Ghent', 'Afsnee', 'Desteldonk', 'Drongen', 'Gentbrugge', 'Ledeberg', 'Mariakerke', 'Mendonk', 'Oostakker', 'Sint-Amandsberg', 'Sint-Denijs-Westrem', 'Sint-Kruis-Winkel', 'Wondelgem', 'Zwijnaarde']}, {'division': 'East Flanders', 'location': 'Ghent'}),
        ({'country': 'Belgium', 'division': 'Geraardsbergen'}, {'division': 'East Flanders', 'location': 'Geraardsbergen'}),
        ({'country': 'Belgium', 'division': ['Hamme', 'Kastel-Moerzeke', 'St-Anna', 'Zogge']}, {'division': 'East Flanders', 'location': 'Hamme'}),
        ({'country': 'Belgium', 'division': ['Kruibeke', 'Bazel', 'Rupelmonde']}, {'division': 'East Flanders', 'location': 'Kruibeke'}),
        ({'country': 'Belgium', 'division': ['Laarne', 'Kalken']}, {'division': 'East Flanders', 'location': 'Laarne'}),
        ({'country': 'Belgium', 'division': ['Lievegem', 'Waarschoot', 'Lovendegem', 'Zomergem']}, {'division': 'East Flanders', 'location': 'Lievegem'}),
        ({'country': 'Belgium', 'division': 'Madegem'}, {'division': 'East Flanders', 'location': 'Madegem'}),
        ({'country': 'Belgium', 'division': ['Merelbeke', 'Bottelare', 'Lemberge', 'Melsen', 'Munte', 'Schelderode']}, {'division': 'East Flanders', 'location': 'Merelbeke'}),
        ({'country': 'Belgium', 'division': 'Nevele'}, {'division': 'East Flanders', 'location': 'Nevele'}),
        ({'country': 'Belgium', 'division': ['Oudenaarde', 'Bevere', 'Edelare', 'Eine', 'Ename', 'Herune', 'Leupegem', 'Mater', 'Melden', 'Mullem', 'Nederename', 'Volkegem', 'Welden', 'Ooike']}, {'division': 'East Flanders', 'location': 'Oudenaarde'}),
        ...
        ({'country': 'Belgium', 'division': 'Wezembeek-Oppem'}, {'division': 'Flemish Brabant', 'location': 'Wezembeek-Oppem'}),
        ...
        ({'country': 'Belgium', 'division': ['Bilzen', 'Beverst', 'Eigenbilzen', 'Grote-Spouwen', 'Hees', 'Hoelbeek', 'Kleine-Spouwen', 'Martenslinde', 'Mopertinen', 'Munsterbilzen', 'Rijkhoven', 'Rosmeer', 'Waltwilder']}, {'division': 'Limburg', 'location': 'Bilzen'}),
        ({'country': 'Belgium', 'division': ['Bocholt', 'Kaulillecity', 'Reppel', 'Lozen', 'Kaulile']}, {'division': 'Limburg', 'location': 'Bocholt'}),
        ({'country': 'Belgium', 'division': 'Bree'}, {'division': 'Limburg', 'location': 'Bree'}),
        ({'country': 'Belgium', 'division': 'Genk'}, {'division': 'Limburg', 'location': 'Genk'}),
        ({'country': 'Belgium', 'division': ['Hasselt', 'Sint-Lambrechts-Herk', 'Wimmertingen', 'Kermt', 'Spalbeek', 'Kuringen', 'Stokrooie', 'Stevoort', 'Runkst', 'Kiewit', 'Godsheide', 'Rapertingen']}, {'division': 'Limburg', 'location': 'Hasselt'}),
        ...
        ({'country': 'Belgium', 'division': ['Leopoldsburg', 'Heppen']}, {'division': 'Limburg', 'location': 'Leopoldsburg'}),
        ({'country': 'Belgium', 'division': 'Lommel'}, {'division': 'Limburg', 'location': 'Lommel'}),
        ({'country': 'Belgium', 'division': 'Lummen'}, {'division': 'Limburg', 'location': 'Lummen'}),
        ({'country': 'Belgium', 'division': ['Maaseik', 'Neeroeteren', 'Opoeteren', 'Aldeneik', 'Heppeneert', 'Wurfeld', '\'t Ven', 'Gremeslo', 'Berg', 'Schootsheide', 'Voorshoven', 'Waterloos', 'De Riet', 'Dorne']}, {'division': 'Limburg', 'location': 'Maaseik'}),
        ({'country': 'Belgium', 'division': ['Maasmechelen', 'Mechelen-aan-de-Maas', 'Vucht', 'Leut', 'Meeswijk', 'Uikhoven', 'Eisden', 'Opgrimbie', 'Boorsem', 'Kotem']}, {'division': 'Limburg', 'location': 'Maasmechelen'}),
        ...
        ({'country': 'Belgium', 'division': ['Peer', 'Grote-Brogel', 'Kleine-Brogel', 'Wauberg', 'Erpekom', 'Wijchmaal']}, {'division': 'Limburg', 'location': 'Peer'}),
        ...
        # West Flanders
        ({'country': 'Belgium', 'division': 'Avelgem'}, {'division': 'West Flanders', 'location': 'Avelgem'}),
        ({'country': 'Belgium', 'division': 'Anzegem'}, {'division': 'West Flanders', 'location': 'Anzegem'}),
        ({'country': 'Belgium', 'division': ['Blankenberge', 'Uitkerke']}, {'division': 'West Flanders', 'location': 'Blankenberge'}),
        ({'country': 'Belgium', 'division': ['Bruges', 'Brugge', 'Assebroek', 'Koolkerke', 'Sint-Andries', 'Sint-Michiels', 'Sint-Kruis', 'Dudzele', 'Lissewege', 'Sint-Jozef', 'Sint-Pieters']}, {'division': 'West Flanders', 'location': 'Bruges'}),
        ({'country': 'Belgium', 'division': 'Deerlijk'}, {'division': 'West Flanders', 'location': 'Deerlijk'}),
        ({'country': 'Belgium', 'division': ['Diksmuide', 'Beerst', 'Esen', 'Kaaskerke', 'Keiem', 'Lampernisse', 'Leke', 'Nieuwkapelle', 'Oostkerke', 'Oudakapelle', 'Pervijze', 'Sint-Jacobs-Kapelle', 'Stuivekenskerke', 'Vladslo', 'Woumen']}, {'division': 'West Flanders', 'location': 'Diksmuide'}),
        ({'country': 'Belgium', 'division': ['Harelbeke', 'Bavikhove', 'Hulste']}, {'division': 'West Flanders', 'location': 'Harelbeke'}),
        ({'country': 'Belgium', 'division': 'Knokke-Heist'}, {'division': 'West Flanders', 'location': 'Knokke-Heist'}),
        ({'country': 'Belgium', 'division': 'Kuurne'}, {'division': 'West Flanders', 'location': 'Kuurne'}),
        ({'country': 'Belgium', 'division': ['Lo-Reninge', 'Lo', 'Noordschote', 'Pollinkhove', 'Reninge']}, {'division': 'West Flanders', 'location': 'Lo-Reninge'}),
        ({'country': 'Belgium', 'division': 'Oostrozebeke'}, {'division': 'West Flanders', 'location': 'Oostrozebeke'}),
        ({'country': 'Belgium', 'division': ['Ostend', 'Oostende', 'Raversijde', 'Stene', 'Zandvoorde']}, {'division': 'West Flanders', 'location': 'Ostend'}),
        ({'country': 'Belgium', 'division': ['Oudenburg', 'Ettelgem', 'Roksem', 'Westkerke']}, {'division': 'West Flanders', 'location': 'Oudenburg'}),
        ({'country': 'Belgium', 'division': ['Poperinge', 'Krombeke', 'Proven', 'Reningelst', 'Roesbrugge-Haringe', 'Roesbrugge', 'Haringe', 'Watou', 'Sint-Jan-Ter-Biezen', 'Abele']}, {'division': 'West Flanders', 'location': 'Poperinge'}),
        ({'country': 'Belgium', 'division': ['Torhout', 'Wijnendale', 'Sint-Henricus', 'De Driekoningen']}, {'division': 'West Flanders', 'location': 'Torhout'}),
        ({'country': 'Belgium', 'division': ['Wervik', 'Geluwe']}, {'division': 'West Flanders', 'location': 'Wervik'}),
        ({'country': 'Belgium', 'division': 'Wevelgem'}, {'division': 'West Flanders', 'location': 'Wevelgem'}),
        ({'country': 'Belgium', 'division': ['Wingene', 'Zwevezele']}, {'division': 'West Flanders', 'location': 'Wingene'}),
        ({'country': 'Belgium', 'division': ['Ypres', 'Ieper', 'Boezinge', 'Brielen', 'Dikkebus', 'Elverdinge', 'Hollebekke', 'Sint-Jan-Vlamertinge', 'Vlamertinge', 'Voormezele', 'Zillebeke', 'Zuidschote']}, {'division': 'West Flanders', 'location': 'Ypres'}),
        

        # Hainaut
        ({'country': 'Belgium', 'division': ['Aiseau', 'Presles']}, {'division': 'Hainaut', 'location': 'Aiseau-Presles'}),
        ...
        ({'country': 'Belgium', 'division': ['Comines-Warneton', 'Komen', 'Comines', 'Comines-ten-Brielen', 'Houthem', 'Warneton', 'Waasten', 'Bas-Warneton', 'Neer-Waasten', 'Ploegsteert', 'Le Bizet']}, {'division': 'Hainaut', 'location': 'Comines-Warneton'}),
        ({'country': 'Belgium', 'division': ['Lens', 'Bauffe', 'Cambron-Saint-Vincent', 'Lombise', 'Montignies-lez-Lens']}, {'division': 'Hainaut', 'location': 'Lens'}),
        ({'country': 'Belgium', 'division': ['La Louvriere', 'La Louviere', 'La louvière', 'La Louvière', 'Haine-Saint-Paul', 'Haine-Saint-Pierre', 'Saint-Vaast', 'Trivieres', 'Boussoit', 'Houdeng-Aimeries', 'Houdeng-Gœgnies', 'Maurage', 'Strepy-Bracquegnies']}, {'division': 'Hainaut', 'location': 'La Louvière'}),
        ({'country': 'Belgium', 'division': 'Le roeulx'}, {'division': 'Hainaut', 'location': 'Le Rœulx'}),
        ({'country': 'Belgium', 'division': ['Les Bons Villers', 'Frasnes-lez-Gosselies', 'Mellet', 'Reves', 'Villers-Pierwin', 'Wayaux']}, {'division': 'Hainaut', 'location': 'Les Bons Villers'}),
        ({'country': 'Belgium', 'division': ['Lessines', 'Ghoy', 'Bois-de-Lessines', 'Lessenbos', 'Ogy', 'Oseke', 'Papignies', 'Papegem', 'Deux-Acren', 'Acren', 'Wannebecq', 'Wannabeek', 'Ollignies', 'Woelingen']}, {'division': 'Hainaut', 'location': 'Lessines'}),
        ({'country': 'Belgium', 'division': ['Merbes-le-Chateau', 'Merbes-le-Château', 'Fontaine-Valmont', 'Labuissiere', 'Merbes-Sainte-Marie']}, {'division': 'Hainaut', 'location': 'Merbes-le-Château'}),
        ...
        ({'country': 'Belgium', 'division': ['Pont-à-Celles', 'Buzet', 'Liberchies', 'Luttre', 'Obaix', 'Thimeon', 'Viesville']}, {'division': 'Hainaut', 'location': 'Pont-à-Celles'}),
        ...
        # Liege
        ({'country': 'Belgium', 'division': 'Ans'}, {'division': 'Liege', 'location': 'Ans'}),
        ({'country': 'Belgium', 'division': ['Baelen', 'Membach']}, {'division': 'Liege', 'location': 'Baelen'}),
        ...
        ({'country': 'Belgium', 'division': ['Bullingen', 'Honsfeld', 'Hunningen', 'Murringen', 'Rocherath', 'Krinkelt', 'Wirtzfeld', 'Manderfeld', 'Afst', 'Allmuthen', 'Andlermuhle', 'Berterath', 'Buchholz', 'Eimerscheid', 'Hasenvenn', 'Hergersberg', 'Holzheim', 'Hullscheid', 'Igelmonder Hof', 'Igelmondermuhle', 'Kehr', 'Krewinkel', 'Lanzerath', 'Losheimergraben', 'Medendorf', 'Merlscheid', 'Weckerath']}, {'division': 'Liege', 'location': 'Bullingen'}),
        ({'country': 'Belgium', 'division': ['Burdinne', 'Hanneche', 'Lamontzee', 'Marneffe', 'Oteppe', 'Vissoul']}, {'division': 'Liege', 'location': 'Burdinne'}),
        ...
        ({'country': 'Belgium', 'division': ['Juprelle', 'Fexhe-Slins', 'Lantin', 'Paifve', 'Slins', 'Villers-Saint-Simeon', 'Voroux-lez-Liers', 'Voroux-les-Liers', 'Wihogne', 'Nudorp']}, {'division': 'Liege', 'location': 'Juprelle'}),
        ({'country': 'Belgium', 'division': ['Kelmis', 'La Calamine', 'Hergenrath', 'Neu-Moresnet', 'Vieille Montagne']}, {'division': 'Liege', 'location': 'Kelmis'}),
        ({'country': 'Belgium', 'division': ['Liege', 'Liège', 'Angleur', 'Bressoux', 'Chenee', 'Glain', 'Grivegnee', 'Jupille-sur-Meuse', 'Rocourt', 'Wandre']}, {'division': 'Liege', 'location': 'Liège'}),
        ({'country': 'Belgium', 'division': 'Limbourg'}, {'division': 'Liege', 'location': 'Limbourg'}),
        ({'country': 'Belgium', 'division': ['Remicourt', 'Momalle', 'Hodeige', 'Lamine', 'Pousset']}, {'division': 'Liege', 'location': 'Remicourt'}),
        ...
        ({'country': 'Belgium', 'division': ['Sprimont', 'Dolembreux', 'Gomze-Andoumont', 'Rouvreux', 'Louveigne', 'Banneux', 'Damre', 'Florze', 'Lince', 'Ogne', 'Presseux', 'Rivage']}, {'division': 'Liege', 'location': 'Sprimont'}),
        ({'country': 'Belgium', 'division': 'Theux'}, {'division': 'Liege', 'location': 'Theux'}),
        ({'country': 'Belgium', 'division': ['Antheit', 'Wanze']}, {'division': 'Liege', 'location': 'Wanze'}),
        ...
        ({'country': 'Belgium', 'division': ['Ciney', 'Achene', 'Braibant', 'Chevetogne', 'Conneux', 'Leignon', 'Pessoux', 'Serinchamps', 'Sovet', 'Chapois']}, {'division': 'Namur', 'location': 'Ciney'}),
        ({'country': 'Belgium', 'division': 'Couvin'}, {'division': 'Namur', 'location': 'Couvin'}),
        ({'country': 'Belgium', 'division': ['Aisemont', 'Le Roux', 'Sart-Eustache', 'Sart-Saint-Laurent', 'Vitrival']}, {'division': 'Namur', 'location': 'Fosses-la-Ville'}),
        ({'country': 'Belgium', 'division': ['Gembloux', 'Beuzet', 'Bossiere', 'Bothey', 'Corroy-le-Chateau', 'Ernage', 'Grand-Leez', 'Grand-Manil', 'Isnes', 'Lonzee', 'Mazy', 'Sauveniere']}, {'division': 'Namur', 'location': 'Gembloux'}),
        ...
        ({'country': 'Belgium', 'division': ['Molenbeek-Saint-Jean', 'Sint-Jans-Molenbeek', 'Molenbeek']}, {'division': 'Brussels-Capital Region', 'location': 'Molenbeek-Saint-Jean'}),
